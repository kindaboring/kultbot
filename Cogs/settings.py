...
# ------------------------------------------------------ #  
    ...
    async def settings (self, ctx):
        ...
        embed = discord.Embed(title=self.bot.translate.msg(ctx.guild.id, "settings", "SERVER_SETTINGS"), description=f"[**Kult Village**](https://kultvillage.com)", color=0xdeaa0c)
