    ...
    async def help(self, ctx, commandName=None):
        ...
        if commandName is not None:
            ...
            if commandName2 is None:
                ...
                embed = discord.Embed(title=f"**{commandName2.name.upper()} COMMAND :**", description="[**Kult Village**](https://www.kultvillage.com/)", color=0xdeaa0c)
